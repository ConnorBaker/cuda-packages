...
class PydanticSequence(RootModel[Sequence[T]], Generic[T]):  # type: ignore
    """
...
class PydanticMapping(RootModel[Mapping[K, V]], Generic[K, V]):  # type: ignore
    """
    ...
    def get(self, key: K, default: T = None) -> V | T:  # pyright: ignore[reportInconsistentOverload]
