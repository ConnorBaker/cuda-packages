...
in
{
  options.data.nvccCompatibilities = mkOption {
    ...
    '';
    type = cuda-lib.types.attrs cuda-lib.types.majorMinorVersion (submodule {
      options = mkOptions {
        clangMaxMajorVersion = {
          description = "The maximum major version of Clang supported by the NVCC available with this CUDA version.";
          type = cuda-lib.types.majorVersion;
        };
        clangMinMajorVersion = {
          description = "The minimum major version of Clang supported by the NVCC available with this CUDA version.";
          type = cuda-lib.types.majorVersion;
        };
        gccMaxMajorVersion = {
          description = "The maximum major version of GCC supported by the NVCC available with this CUDA version.";
          type = cuda-lib.types.majorVersion;
        };
        gccMinMajorVersion = {
          description = "The minimum major version of GCC supported by the NVCC available with this CUDA version.";
          type = cuda-lib.types.majorVersion;
        };
      };
    });
