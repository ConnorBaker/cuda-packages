...
let
  ...
  inherit (upstreamable-lib.versions) versionAtMost versionNewer;
in
{
  /**
    ...
    ```nix
    upstreamable-lib.strings.versionAtMost "1.2.3" "1.2.4"
    => true
    ```

    ```nix
    upstreamable-lib.strings.versionAtMost "1.2.4" "1.2.4"
    => true
    ```

    ```nix
    upstreamable-lib.strings.versionAtMost "1.2.5" "1.2.4"
    => false
    ```
  */
  ...
  /**
    ...
    ```nix
    upstreamable-lib.strings.versionNewer "1.2.3" "1.2.4"
    => false
    ```

    ```nix
    upstreamable-lib.strings.versionNewer "1.2.4" "1.2.4"
    => false
    ```

    ```nix
    upstreamable-lib.strings.versionNewer "1.2.5" "1.2.4"
    => true
    ```
  */
  ...
  /**
    ...
    ```nix
    upstreamable-lib.strings.versionBoundedExclusive "1.2.3" "1.2.5" "1.2.4"
    => true
    ```

    ```nix
    upstreamable-lib.strings.versionBoundedExclusive "1.2.3" "1.2.5" "1.2.3"
    => false
    ```

    ```nix
    upstreamable-lib.strings.versionBoundedExclusive "1.2.3" "1.2.5" "1.2.5"
    => false
    ```
  */
  ...
  /**
    ...
    ```nix
    upstreamable-lib.strings.versionBoundedInclusive "1.2.3" "1.2.5" "1.2.4"
    => true
    ```

    ```nix
    upstreamable-lib.strings.versionBoundedInclusive "1.2.3" "1.2.5" "1.2.3"
    => true
    ```

    ```nix
    upstreamable-lib.strings.versionBoundedInclusive "1.2.3" "1.2.5" "1.2.5"
    => true
    ```
  */
