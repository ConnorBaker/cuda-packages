  ...
  */
  ...
  drvAttrPathsStrategy =
    let
      ...
      isExcluded =
        attrPath: hasAttr (head attrPath) excludeAtTopLevel || hasAttr (last attrPath) excludeAtAnyLevel;
      ...
      includeCond =
        ...
        in
        !(isExcluded attrPath) && attempt.success && attempt.value;
    ...
    in
    {
      inherit includeCond recurseCond;
    };

  drvAttrPaths = attrPaths drvAttrPathsStrategy;
